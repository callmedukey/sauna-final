...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    locale: "ko_KR",
    siteName: "솔로사우나 레포",
    title: "솔로사우나 레포 - 프리미엄 핀란드식 사우나",
    description:
      "서울에 위치한 최고급 핀란드식 사우나. 전통 찜질방과 현대적 스파의 완벽한 조화. 힐링, 마사지, 스파 프로그램으로 완벽한 휴식을 제공합니다.",
    images: [
      {
        url: "/carousel-1.webp",
        width: 1200,
  ...
  twitter: {
    ...
    title: "솔로사우나 레포 - 프리미엄 핀란드식 사우나",
    description:
      "서울에 위치한 최고급 핀란드식 사우나. 전통 찜질방과 현대적 스파의 완벽한 조화.",
