...
const tabData = {
  ...
  men: {
    ...
    title: "남성 룸",
    description:
      "1인 또는 3인이 이용할 수 있는 욕조 타입 룸으로 가족, 지인, 친구와 함께 [우리만의 프라이빗한 공간] 에서 지친 몸과 마음의 스트레스를 풀고, 일상 속에 힐링을 공유하며, 몸과 마음을 재충전할 수 있는 포근하고 따듯한 공간입니다.\n\n샤워실에는 모던한 타일 바탕에 플랜 테리어로, 식물의 녹색이 시각적인 안정감을 더해주며, 좀 더 자연에서 쉬는 듯한 느낌으로 보다 안락하게 목욕을 즐길 수 있습. 가족, 지인, 친구와 함께 샤워 후 사우나의 열에 익숙해진 몸을 시원하게 식히며, 보다 평온하고 행복한 시간을 보내시기 바랍니다.",
