...
const AccountMenuAside = () => {
  ...
  return (
    <aside className="mx-auto flex max-w-screen-lg flex-wrap place-items-center items-center justify-center gap-y-3.5 font-normal ~text-[1.25rem]/[1.5rem] ~mt-[7.5rem]/[16.875rem] ~mb-[4rem]/[8rem] ~gap-x-[3rem]/[6.25rem]">
      <Link
