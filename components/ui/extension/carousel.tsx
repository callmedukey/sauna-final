...
>(({ className, dir, children, ...props }, ref) => {
  ...
  return (
    <div {...props} ref={mainRef} className="w-full overflow-hidden" dir={direction}>
      <div
        ref={ref}
        className={cn(
          "flex w-full",
...
>(({ className, dir, children, ...props }, ref) => {
  ...
  return (
    <div {...props} ref={thumbsRef} className="w-full overflow-hidden" dir={direction}>
      <div
        ref={ref}
        className={cn(
          "flex w-full",
...
>(({ className, index, children, ...props }, ref) => {
  ...
  return (
    ...
    >
      <div
        className={`relative aspect-square ~h-20/40 w-full opacity-50 rounded-md transition-opacity ${
