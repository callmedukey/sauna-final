      ...
      <DialogContent className="3xl:max-w-screen-2xl max-h-[min(80vh,60rem)] max-w-[90%] overflow-y-auto rounded-lg ~px-4/8">
        ...
        <div className="prose prose-sm max-w-none dark:prose-invert">
          ...
          <p>
            ...
            수 있으며 가입해지를 요청할 수도 있습니다. 이용자들의 개인정보
          ...
          <p>
            ...
            &apos;쿠키(cookie)&apos; 등을 운용합니다. 쿠키란 회사의 홈페이지를
          ...
          <ol>
            <li>개인정보보호 침해센터 (privacy.kisa.or.kr / 02-405-5118)</li>
            <li>정보보호마크인증위원회 (www.eprivacy.or.kr / 02-580-9531~2)</li>
            <li>대검찰청 사이버범죄신고 (spo.go.kr / 02-3480-2000)</li>
            <li>경찰청 사이버안전국 (www.ctrc.go.kr / 1566-0112)</li>
          </ol>

          <h3>10. 기타</h3>
          <p>
            홈페이지에 링크되어 있는 웹사이트들이 개인정보를 수집하는 개별적인
            행위에 대해서는 본 &quot;개인정보취급방침&quot;이 적용되지 않음을
            알려 드립니다.
          </p>
