        ...
        <div className="order-2 space-y-1 sm:order-1 xl:order-2 xl:ml-6 xl:space-y-2">
          ...
          <address className="mt-6 flex flex-col items-center space-y-1 not-italic sm:mt-0 sm:items-start xl:space-y-2">
            ...
            <p>
              ...
              <span>서울특별시 동작구 노들로 2길 7, 드림스퀘어 A동 206호</span>
            </p>
          ...
          <nav className="flex items-center justify-center sm:justify-start xl:text-siteGray [&>a:first-child]:pr-4 [&>a:last-child]:pl-4 [&>a]:text-center sm:[&>a]:text-left">
            <Link href="/conditions">이용약관</Link>
            <Link
              href="/privacy"
              className="border-l border-siteBlack xl:border-siteGray"
            >
              개인정보처리방침
            </Link>
          </nav>
