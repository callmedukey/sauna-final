...
const WarningDialog = () => {
  ...
  return (
    <Dialog open={warningOpen} onOpenChange={setWarningOpen}>
      <DialogContent
        className="max-h-[min(80vh,60rem)] max-w-[90%] 
      overflow-y-auto rounded-lg 2xl:max-w-screen-2xl"
      >
        <DialogHeader>
        ...
        <div className="break-keep">
          <div className="border-y border-y-[#999999] py-4 ~mt-[1.5rem]/[3.75rem]">
            <div className="flex flex-col gap-4  bg-white xl:flex xl:flex-row">
              <div className="flex items-start gap-2 py-7 ~text-[1rem]/lg">
                <Image
                  ...
                  height={24}
                />
                <h2 className="xl:min-w-60">
                  사우나를 이용할 수 없는 건강 상태
                </h2>
              </div>
              <ul className="space-y-2 font-medium ~text-[1rem]/lg md:ml-8 xl:py-7">
              ...
              <ul className="space-y-2 font-medium ~text-[1rem]/lg md:ml-8 xl:py-7 ">
                <li className="flex gap-2">
                  ...
                  <span className="text-start">
                    고혈압, 생활습관 관련 질환(당뇨병, 심장병, 뇌졸증,
                    만성질환)이 있는 고객께서는
                    <br />
                    장시간 사우나 이용 또는 냉수 샤워를 삼가해 주시기 바랍니다.
                  </span>
                </li>
                <li className="flex gap-2">
                  {" "}
                  ...
                  <span>
                    안경, 악세사리(목걸이, 귀걸이, 반지, 팔찌, 발찌, 그 외에
                    금속 장신구)를 착용 후 사우나를 즐기실 경우 화상을 입거나
                    악세사리 변형, 변색이 될 수 있으므로 준비해둔 귀중품
                    트레이에 보관해 주시길 바랍니다
                  </span>
                </li>
              </ul>
            ...
            <div className="flex flex-col gap-4  border-b border-b-[#e5e5e5] bg-white p-4 xl:flex-row ">
              ...
              <p className="space-y-2 font-medium ~text-[1rem]/lg md:ml-8 xl:py-7">
            ...
            <div className="flex flex-col gap-4  bg-white p-4 xl:flex-row ">
              <div className="flex items-start gap-2 ~text-[1rem]/lg xl:py-7">
                <Image
                  src={IconMenu}
                  alt="Cancellation ic  on"
                  width={24}
                  height={24}
                />
                <h2 className="xl:min-w-60">
                  예약/변경/환불/취소 시<br /> 주의할 점
                </h2>
              </div>
              <ul className="space-y-2 font-medium ~text-[1rem]/lg md:ml-8 xl:py-7">
                <li>
