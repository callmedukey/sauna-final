    ...
    <Document>
      <Page size="A4" style={styles.page}>
        ...
        <View style={styles.section}>
          ...
          <Text style={styles.text}>• 이용자 : 본 약관에 따라 회사가 제공하는 서비스를 받는 자</Text>
          <Text style={styles.text}>• 이용계약 : 서비스 이용과 관련하여 회사와 이용자간에 체결하는 계약</Text>
          <Text style={styles.text}>
          ...
          <Text style={styles.text}>• 다른 회원의 ID를 부정하게 사용하는 행위</Text>
          <Text style={styles.text}>• 서비스에서 얻은 정보를 복제, 출판 또는 제3자에게 제공하는 행위</Text>
          <Text style={styles.text}>• 회사의 저작권, 제3자의 저작권 등 기타 권리를 침해하는 행위</Text>
          <Text style={styles.text}>• 공공질서 및 미풍양속에 위반되는 내용을 유포하는 행위</Text>
          <Text style={styles.text}>• 범죄와 결부된다고 객관적으로 판단되는 행위</Text>
          <Text style={styles.text}>• 기타 관계법령에 위반되는 행위</Text>

          <Text style={styles.heading}>부 칙</Text>
          <Text style={styles.text}>(시행일) 이 약관은 2024년 1월 1일부터 시행합니다.</Text>
        </View>

        <View style={styles.signatureSection}>
          <Text style={styles.text}>위 약관에 동의하며, 아래 서명으로 이를 확인합니다.</Text>
